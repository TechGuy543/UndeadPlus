...
public class ModUndeadEntityThinker extends EntityMob
{
	...
	public ModUndeadEntityThinker(World par1world)
	{
		...
		tasks.addTask(6, new ModUndeadEntityAIOpenDoor(this, true));
	...
	public void onDeath(DamageSource damagesource)
	{
		...
		{
			if(ModUndeadEntityAIOpenDoor.hasOpenedDoor)
			{
				EntityPlayer var2 = (EntityPlayer)damagesource.getEntity();
				var2.triggerAchievement(ModUndeadMainRegistry.thinkerDoor);
			}
		}
