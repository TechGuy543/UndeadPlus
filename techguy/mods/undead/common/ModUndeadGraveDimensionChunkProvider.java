...
public class ModUndeadGraveDimensionChunkProvider implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    private MapGenVillage villageGenerator = new MapGenVillage(); //TODO:
...

    {
       ...
       //TODO: villageGenerator = (MapGenVillage) TerrainGen.getModdedMapGen(villageGenerator, VILLAGE);
        ravineGenerator = TerrainGen.getModdedMapGen(ravineGenerator, RAVINE);
    }

    public ModUndeadGraveDimensionChunkProvider(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)ModUndeadMainRegistry.dimStone.blockID;
                                }
                    ...
                    else
                    {
                        ...
                        else if (var18 == ModUndeadMainRegistry.dimStone.blockID)
                        {
                            if (var13 == -1)
                            {
                                ...
                                {
                                    var14 = 0;
                                    var15 = (byte)ModUndeadMainRegistry.dimStone.blockID;
                                }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
                ...
                !var11 && this.rand.nextInt(4) == 0)
        {
            ...
            (new ModUndeadGraveDimensionWorldGenLakes(Block.waterStill.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
        }
                ...
                !var11 && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new ModUndeadGraveDimensionWorldGenLakes(Block.lavaStill.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
            }
        }
