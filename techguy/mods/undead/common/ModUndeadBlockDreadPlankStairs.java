...
public class ModUndeadBlockDreadPlankStairs extends BlockStairs
{
	...
	protected ModUndeadBlockDreadPlankStairs(int par1, Block par2Block, int par3)
	{
	...
	{
		return par0 > 0 && Block.blocksList[par0] instanceof ModUndeadBlockDreadPlankStairs;
	}
