...
public class ModUndeadItemReinforcedDoor extends ItemDoor
{
	private Material doorMaterial;

	public ModUndeadItemReinforcedDoor(int par1, Material par2Material)
	{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			var8 = ModUndeadMainRegistry.reinforcedDoor;


			if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) && par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack))
			{
