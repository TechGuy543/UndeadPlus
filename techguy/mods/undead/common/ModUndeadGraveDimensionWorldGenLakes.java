...
public class ModUndeadGraveDimensionWorldGenLakes extends WorldGenerator
{
    private int blockIndex;

    public ModUndeadGraveDimensionWorldGenLakes(int par1)
    {
                ...
                for (var8 = 0; var8 < 16; ++var8)
                {
                    for (var32 = 0; var32 < 16; ++var32)
                    {
                        for (var10 = 0; var10 < 8; ++var10)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + var8, par4 + var10, par5 + var32, ModUndeadMainRegistry.dimStone.blockID);
                            }
                        }
                    }
                }
