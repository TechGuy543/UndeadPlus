...
public class ModUndeadEntityMummy extends EntityMob
{

    public ModUndeadEntityMummy(World world)
    {
        super(world);
        moveSpeed *= 0.3F;
        texture = "/undeadPlus/mob/mummy.png";
        //attackStrength = 4;
    ...
    {
        return "undeadPlusAudio.mobs.mummy.growl";
    }

    protected String getHurtSound()
    {
        return "undeadPlusAudio.mobs.mummy.hit";
    }

    protected String getDeathSound()
    {
        return "undeadPlusAudio.mobs.mummy.die";
    }
