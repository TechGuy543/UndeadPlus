...
public class ModUndeadEntityAITeleportationArrowAttack extends EntityAIBase
{
    World worldObj;
    ...
    public ModUndeadEntityAITeleportationArrowAttack(EntityLiving par1EntityLiving, float par2, int par3, int par4)
    {
    ...
    {
            ModUndeadEntityTeleportationArrow var1 = new ModUndeadEntityTeleportationArrow(this.worldObj, this.entityHost, this.attackTarget, 1.6F, 12.0F);
