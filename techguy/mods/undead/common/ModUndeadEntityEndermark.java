...
public class ModUndeadEntityEndermark extends EntityMob
{
	...
	public ModUndeadEntityEndermark(World par1World)
	{
		super(par1World);
		this.texture = "/undeadPlus/mob/endermark.png";
		this.moveSpeed = 0.2F;
		this.setSize(0.6F, 2.5F);
		this.stepHeight = 1.0F;
        this.tasks.addTask(1, new ModUndeadEntityAITeleportationArrowAttack(this, this.moveSpeed, 1, 60));
	...
	private boolean shouldAttackPlayer(EntityPlayer par1EntityPlayer)
	{
		...
		else
		{
			...
			Vec3 var4 = worldObj.getWorldVec3Pool().getVecFromPool(this.posX - par1EntityPlayer.posX, this.boundingBox.minY + (double)(this.height / 2.0F) - (par1EntityPlayer.posY + (double)par1EntityPlayer.getEyeHeight()), this.posZ - par1EntityPlayer.posZ);
