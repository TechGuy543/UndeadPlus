...
public class ModUndeadTileEntitySummoningTable extends TileEntity
{
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setInteger("summoningUsesRemaining", usesLeft);
	}

	public void readFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		super.readFromNBT(par1NBTTagCompound);
		usesLeft  = par1NBTTagCompound.getInteger("summoningUsesRemaining");
	}
    ...
    public ModUndeadTileEntitySummoningTable()
    {
    }
