...
public class ModUndeadItemBoneBow extends ItemBow
{
	public ModUndeadItemBoneBow(int par1)
	{
		super(par1);
		maxStackSize = 1;
		setMaxDamage(576);
		...
		boolean var5 = par3EntityPlayer.capabilities.isCreativeMode
				|| EnchantmentHelper.getEnchantmentLevel(
						...
						if (var5 || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID)) {
							...
							ModUndeadEntityImmortiumArrow var8 = new ModUndeadEntityImmortiumArrow(par2World,
