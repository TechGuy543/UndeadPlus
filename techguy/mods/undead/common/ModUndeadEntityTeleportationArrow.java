...
public class ModUndeadEntityTeleportationArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public ModUndeadEntityTeleportationArrow(World par1World)
    {
        super(par1World);
    ...
    public ModUndeadEntityTeleportationArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public ModUndeadEntityTeleportationArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public ModUndeadEntityTeleportationArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        Minecraft.getMinecraft().thePlayer.setPosition(Minecraft.getMinecraft().thePlayer.posX + 5 + rand.nextInt(5), Minecraft.getMinecraft().thePlayer.posY + 2 + rand.nextInt(3), Minecraft.getMinecraft().thePlayer.posZ + 5 + rand.nextInt(5));
        ((EntityPlayer)MinecraftServer.getServer().getConfigurationManager().playerEntityList.get(0)).setPosition(rand.nextInt(7), rand.nextInt(3), rand.nextInt(7));
    }
