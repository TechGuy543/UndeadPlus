...
public class ModUndeadRenderImmortiumArrow extends Render
{
    public ModUndeadRenderImmortiumArrow()
    {
    }

    public void renderArrow(ModUndeadEntityImmortiumArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        loadTexture("/undeadPlus/misc/immortiumarrow.png");
        GL11.glPushMatrix();
    ...
    {
        renderArrow((ModUndeadEntityImmortiumArrow)par1Entity, par2, par4, par6, par8, par9);
    }
}
