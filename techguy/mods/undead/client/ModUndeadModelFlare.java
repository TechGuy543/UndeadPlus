...
public class ModUndeadModelFlare extends ModelZombie
{
    public ModUndeadModelFlare()
    {
        this(0.0F);
    }

    public ModUndeadModelFlare(float par1)
    {
    ...
    {
        this.aimedBow = ((ModUndeadEntityFlare)par1EntityLiving).func_82202_m() == 1;
