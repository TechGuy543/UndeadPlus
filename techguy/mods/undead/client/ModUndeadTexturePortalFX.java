...
public class ModUndeadTexturePortalFX extends FMLTextureFX
{
    /** Portal tick counter */
    ...
    public ModUndeadTexturePortalFX()
    {
        super(ModUndeadMainRegistry.dimPortalBlock.blockIndexInTexture);
        setup();
    }
