...
public class ModUndeadModelZkuba extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (onGround > -9990F)
		{
			...
			float f10 = MathHelper.sin(onGround * 3.141593F) * -(helmet.rotateAngleX - 0.7F) * 0.75F;
