...
public class ModUndeadModelHellHound extends ModelBase
{
    ...
    public ModUndeadModelHellHound()
    {
        float f = 0.0F;
        float f1 = 13.5F;
    ...
    {
    	ModUndeadEntityHellHound entityhellhound = (ModUndeadEntityHellHound)entityliving;
        ...
        float f3 = entityhellhound.getInterestedAngle(f2) + entityhellhound.getShakeAngle(f2, 0.0F);
        wolfHeadMain.rotateAngleZ = f3;
        wolfMane.rotateAngleZ = entityhellhound.getShakeAngle(f2, -0.08F);
        wolfBody.rotateAngleZ = entityhellhound.getShakeAngle(f2, -0.16F);
        wolfTail.rotateAngleZ = entityhellhound.getShakeAngle(f2, -0.2F);
        if (entityhellhound.getHellHoundShaking())
        {
            float f4 = entityhellhound.getBrightness(f2) * entityhellhound.getShadingWhileShaking(f2);
