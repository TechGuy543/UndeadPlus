...
public class ModUndeadTextureInfernoFlamesFX extends FMLTextureFX
{
    ...
    public ModUndeadTextureInfernoFlamesFX(int par1)
    {
        super(ModUndeadMainRegistry.infernoFlames.blockIndexInTexture);
        setup();
    }
   ...
   /* 
    ...
    public void bindImage(RenderEngine par1RenderEngine)
    {
        if (this.tileImage == 0)
        {
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, par1RenderEngine.getTexture("/undeadPlus/terrain.png"));
        }
        else if (this.tileImage == 1)
        {
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, par1RenderEngine.getTexture("/undeadPlus/items.png"));
        }
