...
public class ModUndeadModelZombie extends ModelBiped
{
    ...
    public ModUndeadModelZombie()
    {
        this(0.0F);
    }

    public ModUndeadModelZombie(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModUndeadModelZombie(float par1, float par2, int par3, int par4)
    {
        this.heldItemLeft = 0;
